  ...
  return (
    <div className="flex-wrapper">
      ...
      <section className="blurb border-bottom">
        ...
        <p>It's on <a href="https://github.com/oneoffcharacters/CodeOff" className="link">GitHub</a>.</p>
      ...
      <section className="blurb border-bottom">
        ...
        <p>It's on <a href="https://github.com/todaysjam/legacy" className="link">GitHub</a>.</p>
      ...
      <section className="blurb border-bottom">
        ...
        <p>It's on <a href="https://github.com/todaysjam/todaysjam" className="link">GitHub</a>.</p>
      ...
      <section className="blurb border-bottom">
        ...
        <p>It's on <a href="https://github.com/Sherman-Chen/TennisBuddy" className="link">GitHub</a>.</p>
