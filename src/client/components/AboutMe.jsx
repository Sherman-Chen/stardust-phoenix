    ...
    return(
      <div className='flex-wrapper'>
        <section className="blurb">
          ...
          <p><i className="fa fa-hand-peace-o icon"></i>When not developing I can usually be found exercising, playing tennis, playing with Vue.js, binging netflix, or planning out my next personal project!</p>
          ...
          <p><i className="fa fa-coffee icon"></i>I'm always excited with meeting new people and learning from them, let's get in <Link className='link' to='/contact'>touch</Link> sometime over coffee or a meal!</p>
        </section>
      </div>
    )
  }
