    ...
    return(
      <div className='flex-wrapper'>
        <section className="blurb">
          ...
          <p><i className="fa fa-hand-peace-o icon"></i>When not developing I can usually be found playing tennis, binging netflix, or planning out my next personal project!</p>
